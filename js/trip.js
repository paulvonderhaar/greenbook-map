...
var GB = (function() {
  ...
  GB.prototype.addPathToMap = function(){
    ...
    _.each(this.path, function(point, i){
      ...
      // check for url
      if ('url' in point) html = '<a href=https://www.historypin.org'+point.url+' target="_blank">' + name + '</a>';
      html += '<br />' + point.address;

      // check for image
      if ('url' in point && 'image' in point) html += '<a href=https://www.historypin.org'+point.url+' target="_blank"><img src="'+point.image+'&t=t" width="100%" height="100%" /></a>';
      else if ('image_id' in point) html += '<a href=https://www.historypin.org'+point.url+'" target="_blank>"'+point.image+' width="100%" height="100%" /></a>';
